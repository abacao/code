...
#### Enable or disable automatic database migrations  ## TODO:gitlab_rails['auto_migrate'] = true only for first server install, then should be put on false ??  
...
# gitlab_rails['db_sslmode'] = nil # TODO in prod should be changed
# gitlab_rails['db_sslrootcert'] = nil # same as above?
...
# postgresql['listen_address'] = "192.168.33.11"
...
### Advanced settings  # TODO for prod
# postgresql['ha'] = false # TODO: true
